 	 ...
 	 <div class="page-content">
    	<div class="row">
		  ...
		  <div class="col-md-10">
		  	<div class="row">
		  		<div class="col-md-6">
		  			<div class="content-box-large large1">
		  				...
		  				<div class="panel-body">
		  					<div class="row">
		  						...
		  						<div class="col-md-6">
		  							...
		  							{{ Form::text('pro_name', null, ['class' => 'form-control', 'required' =>'']) }}
		  						</div>
		  						<div class="col-md-6">
									{{ Form::label('pro_code', 'Product Code') }}
		  							{{ Form::text('pro_code', null, ['class' => 'form-control', 'required' =>'']) }}
		  						</div>
		  						<div class="col-md-6">
									{{ Form::label('pro_price', 'Price') }}
		  							{{ Form::text('pro_price', null, ['class' => 'form-control', 'required' =>'']) }}
		  						</div>
		  						<div class="col-md-6">
									{{ Form::label('pro_img', 'Image') }}
		  							{{ Form::file('pro_img', null, ['class' => 'form-control', 'required' =>'']) }}
		  						</div>
		  						<div class="col-md-12">
									{{ Form::label('pro_info', 'Product Details') }}
									{{ Form::textarea('pro_info',null, ['class' => 'form-control', 'required' =>'']) }}<br>
		  						</div>
		  						<div class="col-md-12">
		  	...
		  	<div class="row">
		  		<div class="col-md-12 panel-warning">
		  			<div class="content-box-header panel-heading large1">
	  					<div class="panel-title ">New vs Returning Visitors</div>
		  			...
		  			<div class="content-box-large box-with-header large1"> 
			  			Pellentesque luctus quam quis consequat vulputate. Sed sit amet diam ipsum. Praesent in pellentesque diam, sit amet dignissim erat. Aliquam erat volutpat. Aenean laoreet metus leo, laoreet feugiat enim suscipit quis. Praesent mauris mauris, ornare vitae tincidunt sed, hendrerit eget augue. Nam nec vestibulum nisi, eu dignissim nulla.
						<br /><br />
					</div>
		  		</div>
