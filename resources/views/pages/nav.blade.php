				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							...
							@else
								<li><a href="{{ route('profile.index') }}"><i class="fa fa-user"></i> {{ucwords(Auth::user()->name) }}</a></li>
								<li><a href="{{route('viewWishlist')}}"><i class="fa fa-star"></i> Wishlist ({{App\WishList::count()}})</a></li>
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                       @guest
										...
										<li><a href="{{route('pages.product-detail')}}">Product Details</a></li>
					...
					<div class="col-sm-3">
						<div class="search_box pull-right" id="prolist">
						{!! Form::open(['route' => 'search', 'method' => 'POST']) !!}
							{{Form::text('search1', null, ['class' => 'form-control prolist', 'placeholder' => 'Search'] )}}
